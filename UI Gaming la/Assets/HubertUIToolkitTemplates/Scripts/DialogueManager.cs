...
public class DialogueManager : MonoBehaviour
{
    ...
    [SerializeField] private UIDialogueBehaviour dialogueBehaviour;
    ...
    private void HandleTag(string key, string value)
    {
        ...
        {
            case "speaker":
                var hasSpeaker = value != null;
                dialogueBehaviour.ShowSpeaker(hasSpeaker);
                if (hasSpeaker)
                {
                    var speaker = value;
